...
const SectionHeader = () => {
	return (
		<section className="leading-relaxed">
			<div className="mx-auto max-w-screen-lg px-6 py-16 sm:px-6 sm:py-14 lg:px-8 flex flex-col">
					...
					<div className="lg:py-5 mt-4 lg:mt-0 p-3">
						<article className="text-lg sm:text-xl text-gray-800 dark:text-gray-200 leading-loose sm:leading-loose sm:tracking-wide">
							<p className="text-lg sm:text-xl text-gray-800 dark:text-gray-200 leading-loose sm:leading-loose sm:tracking-wide">
								...
								environment where students thrive and become confident lifelong
								learners.
							</p>
						</article>
					</div>
...
const Features = () => {
	return (
		<div className="max-w-screen-lg px-4 py-8 sm:px-6 lg:px-8 lg:py-6 mx-auto">
